...
#import "WJLeiVersionsInfoController.h"
#import "WJLeiNameChangeController.h"

#define WL self.view.frame.size.width
#define HL self.view.frame.size.height

@interface DetaiViewController ()<UITableViewDataSource,UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0)
    {
        ...
        if (indexPath.row == 1)
        {
            WJLeiNameChangeController *nameChangeController = [[WJLeiNameChangeController alloc] init];
    ...
    else if (indexPath.section == 1)
    {
        ...
        {
            //NSLog(@"这个是版本信息");
            WJLeiVersionsInfoController *versionsController = [[WJLeiVersionsInfoController alloc] init];

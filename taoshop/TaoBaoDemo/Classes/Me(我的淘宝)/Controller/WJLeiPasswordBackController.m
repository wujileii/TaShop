//
//  WJLeiPasswordBackController.m

//

#import "WJLeiPasswordBackController.h"
#import <SMS_SDK/SMSSDK.h>

#define WL self.view.frame.size.width
#define HL self.view.frame.size.height

@interface WJLeiPasswordBackController ()<UITextFieldDelegate, NSURLSessionDataDelegate>
{
...
@implementation WJLeiPasswordBackController
...
- (void)buttonNextStep
{
    __weak WJLeiPasswordBackController *weakSelf = self;

...
@interface WJLeiVersionsInfoController ()

@property (strong, nonatomic) NSString *strResult;



@end

@implementation WJLeiVersionsInfoController
...
- (void)speakSomeWords
{
    AVSpeechUtterance *utterance = [AVSpeechUtterance speechUtteranceWithString:@"当前软件版本 1.0.0，制作者：0000"];

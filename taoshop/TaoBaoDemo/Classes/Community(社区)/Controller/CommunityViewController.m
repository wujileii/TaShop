...
#import "WJLeiCommunityViewCell.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UINib *nib = [UINib nibWithNibName:@"WJLeiCommunityViewCell" bundle:nil];
    [self.tableView registerNib:nib forCellReuseIdentifier:cellID];
    WJLeiCommunityViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];

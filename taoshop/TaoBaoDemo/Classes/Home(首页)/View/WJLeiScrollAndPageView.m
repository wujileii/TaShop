//  WJLeiScrollAndPageView.m
//  循环滚动视图//
//  Created by WJLei on 16/6/7.
//  Copyright (c) 2016年 jereh. All rights reserved.//

#import "WJLeiScrollAndPageView.h"

@interface WJLeiScrollAndPageView () <UIScrollViewDelegate>
{
    UIView *_firstView;
    UIView *_middleView;
    UIView *_lastView;
...
@implementation WJLeiScrollAndPageView

...
#import "WJLeiPayViewCell.h"

#define WL self.view.frame.size.width
#define HL self.view.frame.size.height

@interface WJLeiPayViewController ()<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
{
...
@implementation WJLeiPayViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 1)
    {
        UINib *nib = [UINib nibWithNibName:@"WJLeiPayViewCell" bundle:nil];
        [self.tableView registerNib:nib forCellReuseIdentifier:cellID];
        WJLeiPayViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];

...
@interface WJleiSearchViewController () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate>
//{
...
@implementation WJleiSearchViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.delegate.numberOfGoods = strNumber.intValue;
    
    WJLeiBuyViewController *buyController = [[WJLeiBuyViewController alloc] init];
